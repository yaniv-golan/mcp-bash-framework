...
declare -ga MCPBASH_ROOTS_URIS=()
declare -ga MCPBASH_ROOTS_NAMES=()
declare -ga MCPBASH_ROOTS_PATHS=()
declare -g MCPBASH_ROOTS_READY=0
declare -g MCPBASH_ROOTS_PENDING_REQUEST=0
declare -g MCPBASH_ROOTS_PENDING_REQUEST_ID=""
declare -g MCPBASH_ROOTS_GENERATION=0
declare -g MCPBASH_ROOTS_LAST_REQUEST_TIME=0
declare -g MCPBASH_CLIENT_SUPPORTS_ROOTS=0
declare -g MCPBASH_CLIENT_SUPPORTS_ROOTS_LIST_CHANGED=0

# Tunables
declare -g MCPBASH_ROOTS_DEBOUNCE_INTERVAL="${MCPBASH_ROOTS_DEBOUNCE_INTERVAL:-1}"
declare -g MCPBASH_ROOTS_REQUEST_TIMEOUT="${MCPBASH_ROOTS_REQUEST_TIMEOUT:-5}"
