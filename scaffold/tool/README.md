...
- `tool.sh` sources `${MCP_SDK}/tool-sdk.sh` (set by the framework when running tools) so you can call helpers like `mcp_args_get`, `mcp_emit_json`, `mcp_json_obj`, `mcp_progress`, and `mcp_log`. See [SDK Discovery](../../README.md#sdk-discovery) for details.
