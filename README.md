...
```bash
curl -fsSL "https://raw.githubusercontent.com/yaniv-golan/mcp-bash-framework/v0.9.6/install.sh" | bash -s -- --yes --version "v0.9.6"
```
...
```bash
bash install.sh --verify <sha256-from-SHA256SUMS> --version 0.9.6
```
