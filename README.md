...
```bash
curl -fsSL "https://raw.githubusercontent.com/yaniv-golan/mcp-bash-framework/v0.12.0/install.sh" | bash -s -- --yes --version "v0.12.0"
```
...
```bash
bash install.sh --verify <sha256-from-SHA256SUMS> --version 0.12.0
```
